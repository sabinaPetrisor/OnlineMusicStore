<footer class="footer">
    <section class="box-container">
        <div class="footer-box">
            <h3>Quick links</h3>
            <a href="http://localhost/OnlineMusicStore/php/home-page.php"><i class="fas fa-angle-right"></i>Home</a>
            <a href="http://localhost/OnlineMusicStore/php/shop-page.php"><i class="fas fa-angle-right"></i>Shop</a>
